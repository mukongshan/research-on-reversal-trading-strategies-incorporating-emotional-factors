...
# =============== 输入 / 输出 / 模型选择 ===============
DATA_PATH = "../../../mid_result/training_data/merged_2w_scored_titles_LLM.csv"
SAVE_SUMMARY_PATH = "../../../mid_result/model_compare/sentence_only_model_results.csv"
SAVE_LIGHTGBM_PATH = "../../../mid_result/sentence_only_lightgbm.txt"
